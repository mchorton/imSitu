...
def try_parzen():
    ...
    # TODO cross-validate?
    for factor in xrange(16):
        probs = gan.parzenWindowFromFile(ganfile, gantrainset, "data/manygan_lowlearn/data/pairs/", "data/comp_fc7/", logPer=1, bw_method=2 ** factor, test=True)

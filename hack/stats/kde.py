# Slight modifications to scipy.stats.kde.py, to support calling logpdf()
# without NAN-ing during a determinant calculation.
...
class gaussian_kde(object):
    ...
    def logpdf(self, x):
        ...
        if m >= self.n:
            ...
            result = logsumexp(-energy, axis=0)
            result = result - self._log_norm_factor
        else:
            # loop over points
            for i in range(m):
                diff = self.dataset - points[:, i, newaxis]

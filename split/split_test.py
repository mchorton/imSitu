...
class TestSplit(unittest.TestCase):
  ...
  def setUpClass(cls):
    ...
    cls.vrn2Imgs = du.getvrn2Imgs(cls.dataset)
    pass
  ...
  def test_getImageDeps(self):
    deps = du.getImageDeps(self.vrn2Imgs)
    obs = str(deps)
  ...
  def test_numDifferentLabelings(self):
    ...
    counts = du.getDifferers(self.datafile)
  ...
  def test_verbcounts(self):
    self.datafile = "testdiffer.json"
    counts = du.getVerbCounts(self.datafile)
  ...
  def test_distribution(self):
    self.datafile = ["testdiffer.json", "testfunc.json"]
    counts = du.getDistributionOfVerbs(self.datafile)
